...
BroFist Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as BroFist Core, where everyone uses
...
pay attention to for reviewers of BroFist Core code.

General BroFist Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BroFist Core uses tinyformat, which is type safe. Leave them out to avoid confusion
