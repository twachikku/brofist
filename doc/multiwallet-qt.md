...
Only requiring some minor changes is brofist.cpp.
...
Changes to brofist.cpp
----------------------
brofist.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
