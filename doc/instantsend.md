...
This mechanism has been integrated into Bitcore-Node-BroFist which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/brofistcoin/insight-api-brofist#web-socket-api](https://github.com/brofistcoin/insight-api-brofist#web-socket-api) 
* API: [https://github.com/brofistcoin/insight-api-brofist#instantsend-transactions](https://github.com/brofistcoin/insight-api-brofist#instantsend-transactions) 
...
By default, the BroFist Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BroFist Core daemon:
