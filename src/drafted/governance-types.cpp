...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BroFistNetwork") type = BroFistNetwork;
    if(strType == "BroFistNetworkVariable") type = BroFistNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BroFistNetwork) s = "BroFistNetwork";
    if(type == BroFistNetworkVariable) s = "BroFistNetworkVariable";
