...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case PEW: return QString("BroFist");
            case mPEW: return QString("Milli-BroFist (1 / 1" THIN_SP_UTF8 "000)");
            case uPEW: return QString("Micro-BroFist (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-BroFist (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case PEW: return QString("TestBroFists");
