    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BroFist Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BroFist Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  brofist-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BroFist in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PEW, 0.1 PEW, 1 PEW and 10 PEW -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://brofistcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://brofistcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BroFist Core is shutting down...") + "<br /><br />" +
