    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BroFist Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BroFist address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brofist: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BroFist Core"), this);
    aboutAction->setStatusTip(tr("Show information about BroFist Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BroFist Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BroFist addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BroFist addresses"));
    ...
    openAction->setStatusTip(tr("Open a brofist: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BroFist Core help message to get a list with possible BroFist Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BroFist Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BroFist network", "", count));
}
...
{
    QString strTitle = tr("BroFist Core"); // default title
